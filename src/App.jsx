...
import { convertTemperature, getWindDirection, getHumidityValue, getVisibilityValue} from './components/Helper.jsx';
...
const App = () => {
 ...
 const API_KEY = 'cd915d09ac6ba4d8a3493e09844490c2'
  ...
  return (
    ...
    <div className=' flex items-center justify-center p-6 min-h-screen'>
      <div className=' bg-transparent backdrop-filter backdrop-blur-md rounded-xl shadow-2x-1 p-8 max-w-md
